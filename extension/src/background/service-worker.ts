...
import { saveUserSession, getUserSession, clearUserSession, saveExtractionState } from '../services/storage';
...
const CONVEX_URL = 'https://YOUR_CONVEX_URL.convex.cloud';
...
chrome.runtime.onInstalled.addListener((details) => {
  if (details.reason === 'install') {
    // Open popup or onboarding page on first install
